...
<figure>
  <img src="/blog/literature-field-map.svg" alt="A literature review as a map: the field at the top branches into methods, competing models, and applications, each with source papers attached; a disagreement between two papers is flagged, with a branch asking what's the evidence for this" width="1200" height="620" />
  <figcaption>The field mapped into areas, sources attached where they belong — and the disagreement captured as a first-class node.</figcaption>
</figure>
