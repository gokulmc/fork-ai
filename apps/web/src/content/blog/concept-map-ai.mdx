...
<figure>
  <img src="/blog/concept-network.svg" alt="A concept map as a network: four concepts connected by labeled links reading causes, is part of, depends on, and contradicts; the contradicts link has a branch asking whether the relationship is causal or just correlated" width="1200" height="620" />
  <figcaption>In a concept map the links carry the meaning — and every link is a claim you can interrogate.</figcaption>
</figure>
