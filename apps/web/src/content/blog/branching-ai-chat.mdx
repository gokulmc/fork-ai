...
<figure>
  <img src="/blog/tangent-branch.svg" alt="Comparison: in one timeline a side-question takes over the conversation and buries the main topic under tangent messages, while in a tree the tangent becomes its own branch and the main trunk continues exactly where it left off" width="1200" height="640" />
