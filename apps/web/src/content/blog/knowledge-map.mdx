...
<figure>
  <img src="/blog/order-vs-structure.svg" alt="Comparison: notes organized by order are a stack of dated entries that only grow longer, while a knowledge map organizes the same notes by structure, attaching each to the topic it belongs to, with this week's question attaching to an existing node" width="1200" height="620" />
  <figcaption>Order appends; structure compounds. The same notes, organized by when vs by what.</figcaption>
</figure>
