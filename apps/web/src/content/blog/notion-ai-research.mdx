...
<figure>
  <img src="/blog/map-to-notion.svg" alt="Export diagram: a branching research map on the left is exported into a Notion page on the right, which opens with a small map overview followed by collapsible toggle headings for each branch, nested the way they were explored" width="1200" height="620" />
  <figcaption>A proper export: the map overview up top, each branch a toggle heading, the tree intact.</figcaption>
</figure>
