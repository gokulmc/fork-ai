...
// Source-map upload only runs when SENTRY_AUTH_TOKEN is present (CI/prod), so
// local and Amplify builds without it stay green. Sentry itself is a no-op at
// runtime unless NEXT_PUBLIC_SENTRY_DSN is set.
