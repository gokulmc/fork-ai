...
- **GitHub App for private repos + push-back** — commits currently die with the machine; clone-only for private repos needs installation tokens, push-back makes branches durable (ADR-0002 is the decision record for this).
